...
public class GlobalManager extends LibraryManager {
    ...
    private GlobalManager(WaypointPlugin plugin) {
        super(plugin);
        this.plugin = plugin;
    ...
    public static synchronized GlobalManager getManager(WaypointPlugin plugin) {
        if (instance == null) {
    ...
    private void loadFields(WaypointPlugin plugin) {
        defaultLang = plugin.getConfig().getString("language", "en");
        pluginName = ChatColor.translateAlternateColorCodes('&', plugin.getConfig().getString("plugin_name", "WaypointPlugin"));
    ...
    private void saveDefaultConfig() {
        ...
        if (!configFile.exists()) {
            ...
            defaultConfig.set("plugin_name", "WaypointPlugin");
